...
<?php include("../connect.php");
	...
	$sql = "INSERT INTO CUSTOMERS (Name, Address, Credit_Limit) VALUES ('$name', '$address', '$limit')";
...
?>
	...
	<div style="position: absolute; top: 110px; left: 300px; width: calc(100% - 300px); height: calc(100% - 110px); background: linear-gradient(rgb(255,255,255), rgb(228,241,254) 70%);">
		<div style="text-align: center;">
			...
			<b><big><big>New Customer</big></big></b>
			<form name="salesperson" method="post" action="new.php" enctype="	multipart/form-data">
				...
				<table  style="margin: 0 auto;">
					...
					<tr>
						<td> <label style="font-size: 20px; font-family: Helvetica;" for"address">Address: </label> </td>
						<td> <input type="text" id="address" name="address" value=""> </td> 
					</tr>
					<tr>
						<td> <label style="font-size: 20px; font-family: Helvetica;" for"commission">Credit Limit: </label> </td>
						<td> <input type="number" min="0" id="limit" name="limit" value="0"> </td> 
					</tr>
				</table>
